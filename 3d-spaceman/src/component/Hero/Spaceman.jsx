...
export function Spaceman(props) {
  ...
  const ySpring = useSpring(yPosition, { damping: 30, stiffness: 35 })
  ...
  return (
    <group ref={group} {...props} dispose={null} rotation={[-Math.PI / 2, -0.2, 2.2]} scale={props.scale || 0.25} position={props.position || [0, -1, 0]}>
